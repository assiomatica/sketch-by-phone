...
class FileSelection extends Component {
    ...
    render() {
        ...
        if (showGallery) {
            return <Gallery onClose = { this.handleCloseGalleryClick }
        ...
        return ( <
            ...
            <
            div >
            Print a < a style = { styles.a }
            href = { hiro } > hiro marker < /a> <
            /div> <
            ...
            href = { hiro } >
            <
            img style = { styles.hiroMarkerImg }
            alt = "Hiro marker example"
            src = { hiro }
            /> <
            /a> <
            /div> <
            ...
            div >
            <
            RaisedButton style = { styles.btnFileInput }
            secondary fullWidth htmlFor = "file_input"
            onTouchTap = { this.handleFileInputClick }
            label = "From your photo library" >
            <
            input ref = { this.storeFileInputRef }
            id = "file_input"
            ...
            /RaisedButton> <
            /div> <
            RaisedButton secondary fullWidth onTouchTap = { this.handleOpenGalleryClick }
            label = "Our drawings" / >
            <
            /li> <
            /ol> <
